...
const Atuatitle = () => {
  ...
  return (
    <div className="card text-bg-dark">
      ...
      <div>
        <h5 className="display-6" style={{ fontFamily: 'Spectral, sans-serif', textAlign: 'center', padding: '6vw', opacity: textOpacity }}>Áreas de Atuação</h5>
      </div>
